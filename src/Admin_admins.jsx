...
function AddAdmin() {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await axios.post('/admin_details/create', formData);
  ...
  const getFetchData = async () => {
    const data = await axios.get('/admin_details/');
    if (data.data.success) {
  ...
  const handleDelete = async (id) => {
    const data = await axios.delete('/admin_details/delete/' + id);
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
    }
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const data = await axios.put('/admin_details/update', formDataEdit);
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
